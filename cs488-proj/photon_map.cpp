...
//----------------------------------------------------------------------------
/* JSB: File is from Jensen, 1991 Appendix B, additions of:
 - getPhotons()
 - get_stored_photons()
 for use in visualization of raw photon map
 */
 ...
 */
//*****************************************************************
void PhotonMap :: photon_dir( double *dir, const Photon *p ) const
//*****************************************************************
{
...
/* JSB added */
Photon* PhotonMap :: getPhotons(void) {
    return photons;
}

int PhotonMap :: get_stored_photons(void) {
