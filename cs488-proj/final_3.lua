...
gr.render(scene,
      ...
      }, 6, 0.03, 8000, 'photon map', 32, 'pinhole', 180.0, 4) -- num recur, search radius, num photons per search area, render mode, num threads, eye mode, max psi for fisheye, num sqrt(samples) per pixel for stochastic rendering
