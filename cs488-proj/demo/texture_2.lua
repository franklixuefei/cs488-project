...
bn:add_child(cone_3)
cone_3:set_material(clock_texture)
...
torus_3:set_material(clock_texture)
...
frameball_1:set_material(texture1)
...
frameball_2:set_material(wooden)
...
frameball_3:set_material(clock_texture)
